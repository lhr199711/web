<template>
    <div class="affix-details">
        <div class="public-detail">
            <div class="important-info">
                <Row>
                    <Col span="6">
                        <div class="name">附加任务名称：</div>
                        <div class="content">{{ taskData.taskName }}</div>
                    </Col>
                    <Col span="6">
                        <div class="name">附加任务编号：</div>
                            ...
                            <div slot="content">
                                <div class="content">
                                    <ul class="record-list">
                                        <li>
                                            <div class="modify-name">修改附加任务名称：</div>
...
<script>
    import { apiAffixTaskQueryDetail } from '@/api/standard-mapper/additionalTask'
    ...
    export default {
        ...
        methods: {
            ...
            getData () {
                apiAffixTaskQueryDetail({ taskCode: this.taskCode }).then(({ data }) => {
                    this.taskData = data
                })
            },
            showRules (row) {
