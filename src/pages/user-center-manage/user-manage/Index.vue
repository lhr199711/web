        ...
        >
            ...
            <Form ref="formItem" :model="formItem" :rules="ruleInline">
                ...
                <FormItem
                    ...
                    :label-width="120"
                >
                    <Input v-model="formItem.accountNick" style="width: 200px" />
                </FormItem>
                <FormItem label="用户密码" prop="loginPwd" :label-width="120">
...
<script>
    ...
    import {
        ...
        apiAccountDelete,
        apiAccountResetPwd
    } from '@/api/user-center-manage/userManage'
    export default {
        ...
        data () {
            return {
                ...
                // 新增编辑的form表单校验
                ruleInline: {
                    // phoneNumber: [validateRules.required('手机号码')[0], validateRules.phone('正确的电话号码')[0]],
                },
                // 数据项数据
                dataItem: [],
                // 区分当前是否可以调用接口
