    ...
    <div class="feedback-details simple-entry">
            ...
            <div class="l-content">
                <div class="table-data">
                    <ul class="transit">
                        ...
                        <Form ref="formValidate" label-position="left" :model="transitModal" :label-width="100" :rules="ruleValidate">
        ...
        <div class="back">
            ...
            <div class="path-info-details">
                <div v-for="(pathList, pathIndex) of pathData" :key="pathIndex" v-show="pathIndex === pathNum" class="details-switchover">
                    <div class="title">
                                        ...
                                        <ul>
                                            ...
                                            <Form ref="formRoadListValidate" label-position="left" :model="list.serverParam" :label-width="100">
                                                ...
                                                <FormItem v-if="list.serverParam.contaShow" label="集装箱尺寸类型：">
                                                    ...
                                                    <Select v-model="list.serverParam.contaSizeType" clearable @on-open-change="contaSizeTypeChange" style="width:120px;">
                                ...
                                <div class="l-content">
                                    ...
                                    >
                                        <ul>
                                            ...
                                            <!-- 下面的表格 -->
                                            <div class="input-table">
                                                <Form :model="list.serverParam" :label-width="100" label-position="left" >
                                                    <FormItem label="物流类型：" prop="logisticsType">
                                                        <small class="rule-class">*</small>
                                                        <Select v-model="list.serverParam.logisticsType" clearable style="width:120px;">
                                                            <Option v-for="(item, index) in logisticsType" :key="index" :value="item.dictionaryKey">{{ item.dictionaryValue }}</Option>
                    ...
                    <!-- 运输要求模块 -->
                    <div v-else v-for="(list, index) of pathData" :key="index" v-show="index === pathNum" class="trans-requry" >
        ...
        >
            ...
            <ul class="attaching-task-tit">
                <p v-for="(item, key) of taskData" :key="key" v-show="attachingTaskNum === key" class="attaching-task-content">
        ...
        methods: {
            ...
            save (name) {
                ...
                this.$refs.formValidate.validate((valid) => {
                    if (valid) {
                        apiDispatchAddFreight({ data }).then(res => {
