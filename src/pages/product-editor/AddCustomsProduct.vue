                ...
                <Row>
                    ...
                    <Col span="21">
                        <Form
                            ...
                            inline
                        >
                            <!-- <FormItem label="关务类型" prop="dispatchCity">
                                <adt-city-selector @on-change="changeDispatchCity" />
                            </FormItem> -->
                            <FormItem label="关务类型" prop="dispatchSite">
                ...
                <Row>
                    ...
                    <Col span="21">
                        ...
                        >
                            <!-- 综保区报关 -->
                            <template v-if="true">
                                <FormItem label="综保区名称" prop="dispatchCity">
                                    <adt-city-selector @on-change="changeDispatchCity" />
                                </FormItem>
                                <FormItem :label-width="0" prop="dispatchSite">
                            ...
                            <!-- 普通报关 -->
                            <template v-else>
                                <FormItem label="城市" prop="dispatchCity">
                                    <adt-city-selector @on-change="changeDispatchCity" />
                                </FormItem>
                            </template>
                        </Form>
            ...
            <div class="choose-parameter">
                ...
                <div class="container">
                    <Form
                        ...
                        inline
                    >
                        <FormItem label="报关类型" prop="customsType">
                            <CheckboxGroup v-model="parameterData.customsType">
                                <Checkbox v-for="item in customsType" :key="item.dictionaryKey" :label="`${item.dictionaryKey}~${item.dictionaryValue}`">
                                    {{ item.dictionaryValue }}
                                </Checkbox>
                            </CheckboxGroup>
                        </FormItem>
    ...
    export default {
        ...
        data () {
            return {
                ...
                productType: 'C',
                customsType: this.$getDictionary('CUSTOMS_DECLARATION_TYPE'),
                ...
                parameterRuleValidate: {
                    customsType: [
                        validateRules.minMultipleChoice("报关类型")[0]
                    ]
                },
                dispatchOptions: [],
                delUrl: function () {},
...
<style lang="scss" scoped>
    ...
    .choose-parameter /deep/ .ivu-checkbox-group-item {
        display: block;
    }
</style>
