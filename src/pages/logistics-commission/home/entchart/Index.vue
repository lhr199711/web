            ...
            <div class="ji_du">
                ...
                <div class="legend-box">
                    <span class="c_g">
                        ...
                        <span class="text"
                            >{{ jiduObj.echartName[0].name }}年</span
                        >
                    </span>
                    <span class="unsu">
                        <Icon type="md-radio-button-off" />
                    ...
                    itemStyle: {
                        normal: {
                            color: new t.$echarts.graphic.LinearGradient(
                                0, 0, 0, 1,
                                [
                                    { offset: 0, color: this.jiduObj.echartColor[i].star },
                                    // { offset: 0.5, color: '#44C0C1' },
                                    { offset: 1, color: this.jiduObj.echartColor[i].end },
                                ]
                            )
                        }
                    },
