                                ...
                                >
                                    <Row :gutter="2">
                                        <Col span="8">
                                            ...
                                            <FormItem label="单次箱量：">
                                                <Input v-model="list[index].suitcaseQty"></Input>
                                            </FormItem>
                                            ...
                                            <FormItem label="单次体积：">
                                                <Input type="number" v-model="list[index].cargoVol"></Input>
                                            </FormItem>
                                        </Col>
                                        <Col span="8">
                                        ...
                                        <Col span="8">
                                            ...
                                            <FormItem label="包装毛重：">
                                                <Input v-model="list[index].grossWeight1"></Input>
                                            </FormItem>
                                            <FormItem label="包装净重：">
                                                <Input v-model="list[index].netWeight1"></Input>
                                            </FormItem>
                                            <FormItem label="包装件数：">
                                                <Input v-model="list[index].packQty1"></Input>
                                            </FormItem>
                                            <FormItem label="包装体积：">
                                                <Input v-model="list[index].packVol1"></Input>
                                            </FormItem>
                                            <FormItem
                                                class="jz-meaningless"
                                                v-for="(item,index) in 1"
...
export default {
    ...
    data () {
        return {
            ...
            list: [{ isContentShow: false, grossWeight0: null }] // 得到的数据
        }
    },
    watch: {
        list: {
